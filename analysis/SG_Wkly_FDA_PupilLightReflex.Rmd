...
5. Look into models with different N -- missing data?
6. Write down mathematical interpretation of the plots. 
7. Function on Scalar Regression (use class notes)
...
8. Compare scalar vs functional AUC curves (need scalar features from Ben)
...
3. FOCUS on fPCA: Exploratory analyses
  a. Are PC scores associated with demog variables, time from smoking to test or THC user category?
4. Revise interpretation of +/- 2 SD functions for PC1 & PC2 for within subject difference of percent change.
...
data_folder <- "C:/Users/Suneeta/OneDrive - The University of Colorado Denver/FDA/Data"
