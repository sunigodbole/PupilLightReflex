...
analytic.N <- intersect(unique(left_0.df$subject_id), unique(left_0.post$subject_id))
analytic.N <- intersect(analytic.N, unique(left_0.post.w$subject_id))
analytic.N <- intersect(analytic.N, unique(left_0.pt$subject_id))
analytic.N <- intersect(analytic.N, unique(left_0.pt.w$subject_id))
analytic.N <- intersect(analytic.N, unique(right_0.df$subject_id))
analytic.N <- intersect(analytic.N, unique(right_0.post$subject_id))
analytic.N <- intersect(analytic.N, unique(right_0.post.w$subject_id))
analytic.N <- intersect(analytic.N, unique(right_0.pt$subject_id))
analytic.N <- intersect(analytic.N, unique(right_0.pt.w$subject_id))

## Filter all datasets to analytic sample

left_0.df <- left_0.df[left_0.df$subject_id %in% analytic.N,]
left_0.post <- left_0.post[left_0.post$subject_id %in% analytic.N, ]
left_0.post.w <- left_0.post.w[left_0.post.w$subject_id %in% analytic.N ,]
row.names(left_0.post.w) <- left_0.post.w$subject_id

left_0.pt <- left_0.pt[left_0.pt$subject_id %in% analytic.N, ]
left_0.pt.w <- left_0.pt.w[left_0.pt.w$subject_id %in% analytic.N, ]
