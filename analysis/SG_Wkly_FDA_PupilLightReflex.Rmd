...
pcPlot.fxn <- function(df, errband, labtitle){
  # colors <- c("Pop.Mean" = "black", "+2SD" = "red", "-2SD" = "blue")
  
  ggplot(data = data, aes(x = seconds, y = mu))+
    geom_line(aes(color = "black"))+
    geom_line(aes(x = seconds, y = mu + {{errband}}, color = "red"))+
    geom_line(aes(x = seconds, y = mu - {{errband}}, color = "blue"))+
    labs(x = "seconds", 
         y = "Percent Change", 
         color = "Legend", 
         title = labtitle)+
