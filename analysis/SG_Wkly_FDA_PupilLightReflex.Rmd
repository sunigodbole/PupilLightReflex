...
4. Function on Scalar Regression (use class notes)
...
post_dly_plt <- ggplot(data = pred_coef_df, aes(x=frame, y = f2_hat))+
                ...
                labs(title = "Difference in Response between Daily and Non-user", 
                     y = "Differenc in Percent Change")+
                theme_bw()
post_dly_plt


post_dly_plt <- post_dly_plt+annotation_custom(grob = textGrob(label = "Daily user higher minimal constriction"), 
                                               ymin = 1.5, ymax = 4, 
                                               xmin = -50, xmax= -50)
...
ggplot(data = pred_coef_df, aes(x=frame, y = f1_hat))+
  ...
  geom_line(aes(x = frame, y = f1_hat + 2*f1_se), linetype = "longdash")+
  geom_line(aes(x = frame, y = f1_hat - 2*f1_se), linetype = "longdash")+
  labs(title = "Difference in Response between Smoker and Non-user")+
  theme_bw()
```
