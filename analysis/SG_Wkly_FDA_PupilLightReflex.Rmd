...
$$ 
\begin{aligned}
Y_{i}(t) &= f_0(t) + f_1(t)*I(user = occasional)*PCTT + f_2(t)*I(user = daily)*PCTT + b_i(t) + \epsilon_i(t)\\
& b_i(t) \sim GP(0, \Sigma_b) \\
& \epsilon_i(t) \sim N(0, \sigma_{\epsilon}^2) \\
&= \sum_{k=1}^K \xi_{0k}\phi_{0k}(t_i) + \sum_{k=1}^K \xi_{1k}\phi_{1k}(t_i)*I(user = occasional)*PCTT + \sum_{k=1}^K \xi_{2k}\phi_{2k}(t_i)*I(user = daily)*PCTT + \sum_{k=1}^K \xi_{ik}\phi_k(t_i) + \epsilon_i(t)\\
\end{aligned}
$$
